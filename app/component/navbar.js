...
const Navbar = () => {
  ...
  return (
    ...
    <nav className={`  ${pathname == "/Technology/Chatbot" || "/Technology/flutter" ? 'bg-[#18191F]':'bg-black'} items-center  p-4 px-4   2xl:px-20  lg:p-4  `}>
      <div className=" relative xl:px-10  flex items-center justify-between lg:justify-around flex-wrap">
        <div className="flex items-center flex-shrink-0 text-white">
       <Link href="/"> <Image
            src={Logo}
            alt="Techlerate Logo"
            className="h-16 w-48 md:w-96  md:h-14 lg:h-10 xl:h-20 lg:w-60 2xl:w-76"
            width={400}
            height={5}
          />
          </Link>  
